...
const dict: Dict = {
  ...
  sandbox: {
    ...
    subtitle:            'Run a candidate prompt on N entries and diff against existing extractions. No production data is touched.',
    dimension_label:     'Test dimension',
    pick_entries:        'Pick entries (3–10 recommended; that many LLM calls)',
    selected_n:          '{n} selected',
    prompt_label:        'Prompt template',
    rubric_label:        'Rubric',
    reset_to_current:    'Reset to current production version',
    run_button:          'Run sandbox ({n} LLM calls)',
    running:             'Running…',
    no_dimensions:       'No score-format dimensions available',
    no_results:          'Not run yet. Pick a dimension + entries, edit prompt, hit the button above.',
    aggregate_compare:   'Aggregate health comparison',
    th_metric:           'Metric',
    th_baseline:         'Baseline (live)',
    th_candidate:        'Candidate (sandbox)',
    th_delta:            'Δ',
    metric_null:         'null ratio',
    metric_low_conf:     'low_conf ratio',
    metric_hedge:        'midpoint hedge ratio',
    per_entry_results:   'Per-entry diff',
    baseline_label:      'Baseline',
    candidate_label:     'Candidate',
    no_baseline:         '(no live extraction for this entry — never processed?)',
    error_prefix:        'Error',
    sub_dim:             'Sub-dim',
    null_value:          'null',
    score_conf_evidence: '{score}/{conf}',
    failed:              'Failed: {error}',
  },

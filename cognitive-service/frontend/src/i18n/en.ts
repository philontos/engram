...
Meaning: 0.9+ ≈ near-identical semantics; 0.7–0.9 = strongly related; 0.5–0.7 = related; <0.5 = weakly related`,
  ...
  query: {
    stage_intent:        'Intent check',
    stage_baseline:      'Baseline',
    stage_raw_recall:    'Raw recall',
    stage_persona:       'Persona lens',
    stage_explore:       'Graph exploration',
    stage_synthesis:     'Synthesis',
    tool_graph_search:   'Semantic search',
    ...
    md_q:                '**Question**: {q}',
    md_history:          '### History context',
    md_q1:               '### Q1 Baseline',
    md_q2:               '### Q2 Persona',
    md_agent:            '### Agent tool calls',
    md_raw:              '### Raw recall (evidence used by synthesis)',
    md_q3:               '### Q3 Graph insight (synthesis)',
    md_q4:               '## Q4 Theme deep-dive (combined)',

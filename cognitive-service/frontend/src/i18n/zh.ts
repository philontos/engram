...
const dict = {
  ...
  sandbox: {
    title:               'Prompt 沙箱',
    subtitle:            '在 N 条 entry 上跑候选 prompt，与现有抽取做 diff。不写任何生产数据。',
    dimension_label:     '测试维度',
    pick_entries:        '选 entry（建议 3-10 条，会调对应数量的 LLM）',
    selected_n:          '已选 {n} 条',
    prompt_label:        'Prompt 模板',
    rubric_label:        'Rubric',
    reset_to_current:    '恢复当前线上版本',
    run_button:          '运行沙箱（{n} 次 LLM 调用）',
    running:             '运行中…',
    no_dimensions:       '没有可用的 score 维度',
    no_results:          '尚未运行。选维度 + entry，编辑 prompt，点上方按钮。',
    aggregate_compare:   '聚合健康指标对比',
    th_metric:           '指标',
    th_baseline:         '基线（线上）',
    th_candidate:        '候选（沙箱）',
    th_delta:            'Δ',
    metric_null:         'null 占比',
    metric_low_conf:     'low_conf 占比',
    metric_hedge:        '中点 hedge 占比',
    per_entry_results:   '逐条 entry diff',
    baseline_label:      '基线',
    candidate_label:     '候选',
    no_baseline:         '（这条 entry 没有线上抽取，可能从未处理过）',
    error_prefix:        '错误',
    sub_dim:             '子维度',
    null_value:          'null',

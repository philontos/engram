...
const dict: Dict = {
  ...
  pipeline: {
    ...
    subtitle:             'Watch how a single entry is processed step-by-step + algorithm replay tools',
    select_entry:         'Pick entry',
    no_entries:           'No entries yet',
    no_trace:             'No trace for this entry (not yet processed or deleted)',
    timeline_title:       'Pipeline timeline',
    health_title:         'Extraction health',
    health_subtitle:      'Aggregated slice_extraction_health over the last {n} entries',
    health_no_data:       'No health data yet (will appear after running the new extraction)',
    th_dimension:         'Dimension',
    th_obs:               'Observations',
    th_null:              'null %',
    th_low_conf:          'low_conf %',
    th_hedge:             'midpoint hedge %',
    health_legend_null:   'null = LLM explicitly abstained (high = good, prompt is working)',
    health_legend_low:    'low_conf = leftover from old prompt behaviour (should approach 0)',
    health_legend_hedge:  'hedge = score in [45,55] && conf in [0.15,0.5), anchoring residue (lower is better)',
    replay_title:         'Algorithm replay',
    replay_subtitle:      'Rebuild profile from slice_features, zero LLM calls. Use after changing the merge formula.',
    replay_button:        'Replay profile_merge',
    replay_running:       'Replaying…',
    replay_dimension:     'Dimension only',
    replay_dimension_all: 'All dimensions',
    replay_limit:         'First N entries only',
    replay_limit_all:     'All entries',
    replay_done:          '✓ Done: {entries} entries / {features} slice_features replayed / {dims} dimensions / {snaps} snapshots',
    replay_failed:        '✗ Failed: {error}',
    stage_capture:        'Capture',
    stage_slice:          'Slice extraction',
    stage_profile:        'Profile merge',
    stage_backbone:       'Graph growth',
    stage_done:           'Done',
    duration_ms:          '{n}ms',
    llm_calls_n:          '{n} LLM calls',
    feature_count_n:      '{n} features',
    profile_changed_n:    '{n} sub-dims updated',
    nodes_n:              '{n} nodes',
    edges_n:              '{n} edges',
    none_yet:             '—',
  ...
  entries: {
    ...
    process: {
      ...
      group_slice:             'Slice & profile',
      group_activation:        'Activation',
      group_backbone:          'Backbone growth',
      stages: {
        pipeline:                  'Overall pipeline',
        slice:                     'Slice',
        slice_situation:           'Situation analysis',
        slice_facts:               'Basic facts',
        slice_mbti:                'MBTI personality slice',
        slice_ocean:               'OCEAN big five',
        slice_reg_focus:           'Regulatory focus',
        slice_schwartz:            'Schwartz values',
        activation:                'Domain activation',
        rough_retrieval:           'Rough retrieval',
        node_extract_internal:     '{domain}: internal node extract',
        node_extract_external:     '{domain}: external node expand',
        node_resolution:           'Node resolution & dedup',
        precise_retrieval:         'Precise retrieval (subgraph)',
        algo_edges:                'Algorithmic similarity edges',
        edge_extract:              'LLM edge extract',
        association:               'Co-occurrence edges',
        opposition_propagation:    'Opposition propagation',
        backbone:                  'Backbone growth',
      },
      status: {
        pending:                 'pending',
        running:                 'running',
      ...
      detail: {
        loading:                 'Loading full I/O detail…',
        ...
        truncated_hint:          'Payload truncated. See full LLM response below.',
        no_detail:               'No detail to expand for this stage',
        load_failed:             'Load failed: {error}',
      },
      banner: {
        stream_lost:             'Event stream lost',
      },
    },
...
Meaning: 0.9+ ≈ near-identical semantics; 0.7–0.9 = strongly related; 0.5–0.7 = related; <0.5 = weakly related`,
  ...
  contacts: {
    ...
    action_reset_kind: 'Reset kind',
    merge_dialog_title: 'Merge into',
    merge_dialog_preview: 'Merge preview',
    merge_dialog_confirm: 'Confirm merge',
    merge_dialog_aliases_label: 'Aliases →',
    merge_dialog_kind_label: 'Kind →',
    merge_dialog_null_placeholder: '(unset)',
    evidence_section_title: 'Evidence ({count})',
    evidence_empty: 'No evidence yet',
    kind_locked_tooltip: 'Locked by user; LLM will not change',
    confirm_empty: 'No confirmed contacts yet',
    candidate_empty: 'No pending candidates',
    ambiguous_empty: 'No ambiguous items',
    alert_delete_confirmed_blocked: 'Cannot delete confirmed contacts; use merge',
    alert_save_failed: 'Save failed: {error}',

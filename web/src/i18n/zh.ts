...
含义：0.9+ = 几乎相同语义；0.7–0.9 = 强相关；0.5–0.7 = 有关联；<0.5 = 弱相关`,
  ...
  contacts: {
    tab_title: '人脉',
    confirmed_count: '已确认 ({count})',
    candidates_count: '待确认 ({count})',
    ambiguous_count: '存疑 ({count})',
    search_placeholder: '搜索...',
    filter_kind_all: '全部关系',
    kind_friend: '朋友',
    kind_colleague: '同事',
    kind_family: '家人',
    kind_romantic: '恋人',
    ...
    field_aliases: '别名',
    field_kind: '关系',
    field_active_status: '活跃度',
    field_intimacy: '亲密度',
    field_context_summary: '备注',
    action_confirm: '确认',
    action_merge: '合并…',
    action_delete: '删除',
    action_save: '保存',
    action_new: '新建',
    action_dismiss: '忽略',
    action_reset_kind: '重置关系类型',
    merge_dialog_title: '合并到',
    merge_dialog_preview: '合并预览',
    merge_dialog_confirm: '确认合并',
    merge_dialog_aliases_label: '别名 →',
    merge_dialog_kind_label: '关系 →',
    merge_dialog_null_placeholder: '（未定）',
    evidence_section_title: '证据 ({count})',
    evidence_empty: '暂无证据',
    kind_locked_tooltip: '关系类型已被用户锁定，LLM 不再修改',
    confirm_empty: '暂无已确认的人脉',
    candidate_empty: '暂无待确认候选',
    ambiguous_empty: '暂无存疑条目',
    alert_delete_confirmed_blocked: '已确认人脉不能直接删，请使用合并',
    alert_save_failed: '保存失败：{error}',
    alert_merge_failed: '合并失败：{error}',
  },
